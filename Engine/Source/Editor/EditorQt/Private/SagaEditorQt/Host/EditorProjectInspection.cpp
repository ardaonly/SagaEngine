...
[[nodiscard]] QJsonArray PathReferencesJson(
    const std::vector<Authoring::ProjectReadinessPathReference>& references)
{
    QJsonArray output;
    ...
    const EditorProjectInspectionRequest& request)
{
    ...
    const Authoring::ProjectReadinessView project =
        Authoring::LoadProjectReadinessView(request.projectPath);
    ...
    const QJsonObject report{
        ...
        {"editorReadModel", QJsonObject{
            {"technicalEvaluationProjectOk", project.ok},
