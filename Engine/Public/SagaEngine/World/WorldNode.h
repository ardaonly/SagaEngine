...
public:
    ...
    void MarkEntityDirty(EntityId id, ComponentMask mask) noexcept;
    ...
    [[nodiscard]] std::vector<std::pair<uint32_t, ComponentMask>>
...
private:
    ...
    void SerializeEntityComponents(uint32_t entityId, ComponentMask activeMask,
    ...
    std::unordered_map<EntityId, EntityDirtyState> m_entityDirtyStates;
