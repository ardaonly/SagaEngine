...
internal static class Phase156Reports
{
    private static readonly EvidenceSpec[] RequiredEvidence =
    [
        new("source-truth-inventory", "Phase 126-133", "source-truth-inventory", "source_truth_inventory_report.json"),
        new("source-truth-gate", "Phase 126-133", "source-truth-gate", "source_truth_gate_report.json"),
        new("scene-validation", "Phase 134-140", "scene-entity-validate", "scene_entity_validation_report.json"),
        new("asset-reference-gate", "Phase 134-140", "asset-reference-gate", "asset_reference_gate_report.json"),
        new("freshness", "Phase 134-140", "generated-freshness-gate", "generated_artifact_freshness_report.json"),
        new("runtime-readiness", "Phase 141-148", "runtime-readiness-gate", "runtime_readiness_gate_report.json"),
        new("package-alignment", "Phase 146", "source-truth-alignment", "package_source_truth_alignment_report.json"),
        new("launch-alignment", "Phase 147", "source-truth-alignment", "launch_source_truth_alignment_report.json"),
        new("hedef4-closure", "Phase 155", "hedef4-closure", "hedef4_closure_report.json"),
    ];
    ...
    [
        ...
        "ReadyForImplementationPlanning does not mean Runtime, ClientHost, or Client Preview exists.",
    ];
