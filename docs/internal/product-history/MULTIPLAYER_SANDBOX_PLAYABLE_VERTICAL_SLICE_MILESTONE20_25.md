# MultiplayerSandbox Playable Vertical Slice Milestone 20-25

> Block C evidence for Target 1 / Technical Preview Technical Preview product work.

Milestone 20-25 establishes the first reproducible local preview path for
...
input state, and preview state. This milestone does not add that UI surface.
