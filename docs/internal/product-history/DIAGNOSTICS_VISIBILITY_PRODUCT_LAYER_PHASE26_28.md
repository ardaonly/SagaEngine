# Diagnostics Visibility Product Layer Phase 26-28

> Block D evidence for Target 1 / Technical Preview Technical Preview product work.

Phase 26-28 adds `Tools/SagaProbe`, a read-only CLI for turning diagnostics
...
The Phase 28 bridge is CLI-only through `sagaprobe latest`. The current product
