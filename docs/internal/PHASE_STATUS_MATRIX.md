...
| 11 | C# Gameplay Script v1 | Implemented-Unverified | `docs/internal/phase-evidence/PHASE_11/` | scripting-gate | `-` | StarterArena has SagaScript analyze and compile evidence for one C# script; runtime execution remains deferred. |
