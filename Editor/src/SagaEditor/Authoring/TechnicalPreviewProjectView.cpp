...
void LoadPathReferences(const Json& rootJson,
                        ...
                        std::vector<TechnicalPreviewPathReference>& out)
{
    ...
    for (const Json& item : *it)
    {
        ...
        out.push_back(TechnicalPreviewPathReference{
            StringField(item, "id"),
...
void AddSubsetFailure(TechnicalPreviewProjectView& view,
...
TechnicalPreviewProjectView LoadTechnicalPreviewProjectView(
    const std::filesystem::path& manifestPath)
{
    TechnicalPreviewProjectView view;
