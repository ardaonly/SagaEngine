...
script for SagaScript compile/analyze evidence only. The runtime smoke does not
execute that script, and the sample does not use renderer, client networking,
server authority, Visual Blocks, editor workflow, package output, or
distribution output.
